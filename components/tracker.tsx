  ...
  return (
    <>
      <div
        ref={dotOutline}
        className={cn(
          "cursor-dot-outline border border-neutral-500 shadow h-10 aspect-square rounded-full opacity-0 hidden md:block z-9992 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none fixed transition-transform duration-300",
          {
            "scale-0": mouseActive,
          },
        )}
      ...
      <div
        ref={dot}
        className={cn(
          "cursor-dot bg-gray-500 shadow h-2 aspect-square rounded-full opacity-0 hidden md:block z-9992 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none fixed border-0 border-white border-spacing-2 p-0 transition-[border,padding,height] duration-150 mix-blend-difference",
          {
            "border p-1 bg-gray-500/80 scale-150 -translate-y-1/2 -translate-x-1/2":
              mouseActive,
          },
        )}
      ></div>
