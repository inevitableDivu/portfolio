...
const HomeContent = () => (
    <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="max-w-6xl text-center space-y-8 px-6 mx-auto"
    >
        ...
        >
            ...
            experiences. With a deep love for JavaScript and a passion for
            interactive design, I bring concepts to life with code that feels as
            smooth as a favorite track. Inspired by everything from timeless
            classics to modern beats, my work blends creativity with
            functionality. Whether it’s building unique applications or diving
            into conversations about the future of tech, I’m all about crafting
            thoughtful, engaging digital experiences.
        </motion.p>
        ...
        >
            Let's turn great ideas into something extraordinary—one line of code
            at a time.
        </motion.p>
        ...
        >
            {stats.map((stat, idx) => (
                <div key={stat.label} className="flex items-center">
                    {idx > 0 && (
                        <div className="h-10 w-px bg-border mx-4 md:mx-8" />
                    )}
